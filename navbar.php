    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav col-md-7 offset-md-6">
          <a class="nav-item nav-link active" id="teks" href="login.php" style="color: white;"><i class="fa fa-home"></i> Home</a>
          <a class="nav-item nav-link active" id="teks" href="https://otakulifee.com/portfolio" style="color: white;"><i class="fas fa-info"></i> Tentang Kami</a>
